...
class  ASearchBook extends JFrame implements ActionListener
{
	JPanel p,p1,p2,ph;
	ImageIcon img;
	JLabel  limg,l,l1,l2,lh,Bk_id,Bk_Nm,Bk_P_Nm,Bk_P_Y,Bk_Price,Bk_Q,Bk_pg,Bk_C,Bk_S;;
	JTextField ts,t1,t2,t3,t4,t5,t6,t7,t8;
	Font f,f1,f2;
...
public void actionPerformed(ActionEvent e)
{
	...
	if(o==b1)
	{
		...
		//String st =JOptionPane.showInputDialog(this,"Enter B_ID to be Show Record","Book_Id");
		search();
	}
